...
const App = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col relative">
      {/* Nav Bar */}
      <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-4 px-4 fixed w-full top-0 z-10 shadow-md">
        <div className="flex items-center justify-between">
          <div className="text-xl font-bold">LoyaltyRewards</div>
              ...
              {rewardEarned ? (
                ...
                <div className="text-center py-8">
                  <div className="w-16 h-16 mx-auto bg-gray-100 rounded-full flex items-center justify-center mb-3">
                    <i className="fas fa-gift text-gray-400 text-2xl"></i>
                  </div>
          ...
          <div className="px-4 py-6">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
              <div className="flex items-center mb-6">
                <div className="h-20 w-20 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-full flex items-center justify-center text-white text-2xl font-bold">
                  JD
                </div>
                <div className="ml-4">
